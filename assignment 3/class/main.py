...
single_quote = 'hira hanif'
double_quote = "Python is fun"
triple_quote = '''Here There!
hira hanif Write a Multi Line String Code'''
...
print("hira \nhanif") #new line
print("hira \thanif") #tab space
print("This is a backslash: \\")
print("hira Said, \"Python is Awesome\"") #using double quote inside a string
print("BackSpace example : hira\bhanif") #Backspace
...
print(my_string[0:6]) #hira
print(my_string[6:0]) #hanif
print(my_string[:]) #hirahanif
...
dict_example = dict([('name', 'hira'), ('age', 27)])
